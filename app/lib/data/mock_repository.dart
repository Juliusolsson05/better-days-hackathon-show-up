...
class MockRepository implements Repository {
  ...
  final _venues = const [
    VenueOption(
      ...
      lng: -122.4185,
      pitch:
          'Small plates, no TVs, a back room quiet enough to actually hear each other.',
    ...
    VenueOption(
      ...
      lng: -122.3885,
      pitch:
          'Intro session at 7. Nobody has to make conversation while holding a rope.',
    ...
    VenueOption(
      ...
      lng: -122.4193,
      pitch:
          'Coffee and a long table. The low-key option if a bar feels like a lot.',
      categories: ['cafes'],
    ),
  ];
  ...
  @override
  Future<bool> hasProfile() async => _me != null;
  ...
  void formGroup() {
    _group = Group(
      ...
      members: [
        Member(
          id: 'me',
          displayName: _me?.displayName ?? 'You',
          avatar: _me?.avatar ?? '🙂',
        ),
        ..._members,
      ],
    ...
    _messages
      ...
      ..addAll([
        Message(
          ...
          avatar: '',
          body:
              'Six of you matched on climbing, music and making things. '
  ...
  Future<void> sendMessage(String groupId, String body) async {
    _messages.add(
      Message(
        ...
        authorId: 'me',
        authorName: _me?.displayName ?? 'You',
        avatar: _me?.avatar ?? '🙂',
        body: body,
        sentAt: DateTime.now(),
      ),
  ...
  Future<Assignment> assignment(String groupId) async {
    ...
    return const Assignment(
      ...
      targetName: 'Tom',
      question:
          'Ask Tom what the first record was that made him care about how something '
