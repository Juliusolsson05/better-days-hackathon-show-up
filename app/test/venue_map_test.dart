...
void main() {
  ...
  testWidgets('a venue without coordinates falls back to its address', (tester) async {
    ...
    await tester.pumpWidget(const MaterialApp(
      home: Scaffold(body: VenueMap(venue)),
    ));
  ...
  test('hasLocation requires both coordinates, not either', () {
    const both = VenueOption(
      id: 'a', name: 'n', address: 'a', pitch: 'p', categories: [],
    ...
    const latOnly = VenueOption(
      id: 'b', name: 'n', address: 'a', pitch: 'p', categories: [], lat: 37.75,
    );
